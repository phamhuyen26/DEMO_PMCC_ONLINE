...
<head>
    ...
    <title ng-bind-template="{{titleService.getTitle()}}">NHOM10 DEMO</title>
    ...
    <default-layout class="ng-star-inserted">
        <div class="cl-main-wrapper">
                            ...
                            <div class="cl-d-none cl-d-lg-inline-flex cl-cut-text-wrapper">
                                <div dropdownkey=""
                                    ...
                                    <div dropdownkeybutton="" triggers="manual" placement="bottom" tabindex="0"
                                        ...
                                        class="cl-dropdown-toggle pointer cl-cut-text fs-4 fw-bold" style="color:#fff;">
                                        <?php echo $row['HoTen']?>'s
                                        workspace </div>
                                    <!---->
                                    <!---->
                                </div>
          ...
          box-shadow: 0 0 10px rgba(0, 0, 0, 0.5);">
                                ...
                                <div class="cl-sidebar-container">
                                    <div class="cl-navbar-container">
                                        <ul class="cl-navbar-nav">
                                            <li routerlinkactive="cl-active"
                                                class="cl-nav-item cl-dropdown ng-star-inserted"><a
                                                    routerlink="/timesheet" class="cl-nav-link cl-blue"
                                                    href="/Demo_HQTCSDL/" style="padding-left: 15px;">
                                            ...
                                            <li routerlinkactive="cl-active"
                                                class="cl-nav-item cl-dropdown ng-star-inserted"><a
                                                    routerlink="/tracker" class="cl-nav-link cl-orange" href="/tracker"
                                                    style="padding-left: 15px;"><span class="ng-star-inserted">Chấm
                                                        công</span>
                                                    <!---->
                                                    <!---->
                                                    </span>
                                                ...
                                                <div class="cl-dropdown-menu cl-pink cl-dropdown-menu-nav">
                                                    <div>
                                                        <!---->
                                                        <!----><a routerlinkactive="cl-active"
                                                            routerlink="/reports/summary" class="cl-dropdown-item"
                                                            href="/Demo_HQTCSDL/Interface/CheckIn.php"> CheckIn </a><a
                                                            routerlinkactive="cl-active" routerlink="/reports/detailed"
                                            ...
                                            <!---->
                                            <li routerlinkactive="cl-active" class="cl-nav-item cl-dropdown"><a
                                                    routerlink="/calendar" class="cl-nav-link cl-indigo"
                                                    href="/calendar" style="padding-left: 15px;"><span
                                                        class="cl-nav-link-copy">Báo cáo</span></a>
                                                <div class="cl-dropdown-menu cl-pink cl-dropdown-menu-nav">
                                                    <div>
                                                        <!---->
                                                        <!----><a routerlinkactive="cl-active"
                                                            routerlink="/reports/summary" class="cl-dropdown-item"
                                                            href="/reports/summary"> Tạo báo cáo </a><a
                                                            routerlinkactive="cl-active" routerlink="/reports/detailed"
                                                            class="cl-dropdown-item" href="/reports/detailed"> Xem báo
                                                            cáo </a>
                                                        <!---->
                                                    </div>
                                                    <!---->
                                            ...
                                            <li routerlinkactive="cl-active" class="cl-nav-item cl-dropdown"><a
                                                    routerlink="/dashboard" class="cl-nav-link cl-light-green"
                                                    href="/dashboard" style="padding-left: 15px;"><span
                                                        class="cl-nav-link-copy">Lịch sử chấm
                                                        công</span></a>

                                                <!---->
                                            </li>
                                            <li routerlinkactive="cl-active"
                                                class="cl-nav-item cl-dropdown ng-star-inserted">
                                                </span><a routerlink="/reports/summary"
                                                    class="cl-nav-link cl-dropdown-toggle cl-pink cl-d-none cl-d-lg-flex"
                                                    href="/reports/summary" style="padding-left: 15px;"><span
                                                        class="cl-nav-link-copy">Bảng lương</span></a>
                                                <div class="cl-dropdown-menu cl-pink cl-dropdown-menu-nav">
                                                    <div>
                                                        <!---->
                                                        <!----><a routerlinkactive="cl-active"
                                                            routerlink="/reports/summary" class="cl-dropdown-item"
                                                            href="./Interface/NhanVien/XemBangLuong.php"> Xem bảng lương
                                                        </a><a routerlinkactive="cl-active"
                                                            routerlink="/reports/detailed" class="cl-dropdown-item"
                                                            href="/Demo_HQTCSDL/Interface/KeToan/CapNhatLuong.php"> Cập
                                                            nhật lương </a>
                                                        <!---->
                                                    </div>
                                                </div>
                                            ...
                                            <li routerlinkactive="cl-active"
                                                class="cl-nav-item cl-dropdown ng-star-inserted"><a
                                                    routerlink="/projects" class="cl-nav-link cl-yellow"
                                                    href="/projects" style="padding-left: 15px;"><span
                                                        class="cl-nav-link-copy"> Công việc </span></a>
                                                <div class="cl-dropdown-menu cl-pink cl-dropdown-menu-nav">
                                                    <div>
                                                        <!---->
                                                        <!----><a routerlinkactive="cl-active"
                                                            routerlink="/reports/summary" class="cl-dropdown-item"
                                                            href="./Interface/BangCongViec.php"> Xem bảng công việc
                                                        </a><a routerlinkactive="cl-active"
                                                            routerlink="/reports/detailed" class="cl-dropdown-item"
                                                            href="/Demo_HQTCSDL/Interface/QuanLy/CapNhatCongViec.php"> Cập nhật công
                                                            việc </a>
                                                        <!---->
                                                    </div>
                                                </div>
                                            ...
                                            <!---->
                                            <li routerlinkactive="cl-active"
                                                class="cl-nav-item cl-dropdown ng-star-inserted"><a routerlink="/teams"
                                                    class="cl-nav-link cl-purple" href="/teams"
                                                    style="padding-left: 15px;"><span
                                                        class="cl-nav-link-copy">Đơn</span></a>
                                                <div class="cl-dropdown-menu cl-pink cl-dropdown-menu-nav">
                                                    <div>
                                                        <!---->
                                                        <!----><a routerlinkactive="cl-active"
                                                            routerlink="/reports/summary" class="cl-dropdown-item"
                                                            href="/reports/summary"> Tạo dơn </a><a
                                                            routerlinkactive="cl-active" routerlink="/reports/detailed"
                                                            class="cl-dropdown-item" href="/reports/detailed"> Xem đơn
                                                        </a>
                                                        <!---->
                                                    </div>
                                                </div>
                                            ...
                                            <li routerlinkactive="cl-active"
                                                class="cl-nav-item cl-dropdown ng-star-inserted"><a
                                                    class="cl-nav-link cl-deep-orange cl-pr-2" href="/clients"
                                                    style="padding-left: 12px;"><span
                                                        class="cl-nav-link-copy cl-cut-text">Hồ sơ nhân
                                                        viên
                                                        <!---->
                                                        <!---->
                                                        <!---->
                                                ...
                                                <div class="cl-dropdown-menu cl-pink cl-dropdown-menu-nav">
                                                    <div>
                                                        ...
                                                        <!----><a routerlinkactive="cl-active"
                                                            routerlink="/reports/summary" class="cl-dropdown-item"
                                                            href="/reports/summary">Danh sách nhân viên</a><a
                                                            routerlinkactive="cl-active" routerlink="/reports/detailed"
                                                            class="cl-dropdown-item" href="/reports/detailed">Thêm nhân
                                                            viên</a>
                                                        <a routerlinkactive="cl-active" routerlink="/reports/detailed"
                                                            class="cl-dropdown-item" href="/reports/detailed">Sửa thông
                                                            tin nhân viên</a>
                                                        <a routerlinkactive="cl-active" routerlink="/reports/detailed"
                                                            class="cl-dropdown-item" href="/reports/detailed">Xóa nhân
                                                            viên</a>
                                                        <!---->
                                                    </div>
                                                </div>
            ...
            <main id="layout-main" class="cl-layout-main" style="padding-top: 40px;">
                <div class="container" style="padding:0 250px;">
                    <div class=""><h1>Chi tiết công việc</h1></div>
                    <?php
                        $ngay = $_GET['ngay'];
                        $sql = "SELECT * from congviec where Ngay='$ngay'";
                        ...
                        if(mysqli_num_rows($result) > 0){
                            $row = mysqli_fetch_assoc($result);
                    ?>
                            <div class="mb-4 mt-5"><h2 style="margin-bottom:0;">Mã nhân viên phụ trách</h2> <?php echo $row['MaNV'];?></div>
                            <div class="mb-4 Duan">
                                <div class="mb-4 ">
                                    <h2 style="margin-bottom:0;">Mã dự án</h2>
                                    <span><?php echo $row['MaDuAn'];?></span>
                                </div>
                                <div class="mb-4 ">
                                    <h2 style="margin-bottom:0;">Tên dự án</h2>
                                    <span><?php echo $row['TenDuAn'];?></span>
                                </div>
                                <div class="mb-4 row">
                                    <div class="mb-4 NgayNhan col-lg-6">
                                        <h2 style="margin-bottom:0;">Ngày nhận dự án</h2>
                                        <span><?php echo $row['NgayNhan'];?></span>
                                    </div>
                                    <div class="mb-4 NgayBanGiao col-lg-6">
                                        <h2 style="margin-bottom:0;">Ngày bàn giao dự án</h2>
                                        <span><?php echo $row['HanBanGiao'];?></span>
                                    </div>
                                </div>
                                <div class="mb-4 ">
                                    <h2 style="margin-bottom:0;">Tiến độ</h2>
                                    <span><?php echo $row['TienDo'];?></span>
                                </div>
                            </div>
                            <div class="mb-4 Desc">
                                <h3>Mô tả</h3>
                                <span><?php echo $row['NhiemVuCV'];?></span>
                            </div>
                    <?php
                        }
                    ?>
