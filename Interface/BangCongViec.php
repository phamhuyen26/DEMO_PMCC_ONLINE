                                                ...
                                                <div class="cl-dropdown-menu cl-pink cl-dropdown-menu-nav">
                                                    <div>
                                                        ...
                                                        <!----><a routerlinkactive="cl-active"
                                                            ...
                                                            routerlink="/reports/detailed" class="cl-dropdown-item"
                                                            href="./QuanLy/CapNhatCongViec.php"> Cập nhật công
                                                            việc </a>
                                                        <!---->
                                                    </div>
                                                </div>
            ...
            <main id="layout-main" class="cl-layout-main" style="padding-top: 40px;">
                <div class="container">
                    <table class="table">
                        ...
                        <tbody>
                            <?php
                                $sql = "SELECT MaNV, Ngay, TrangThai FROM nhiemvu";
                                $result = mysqli_query($conn,$sql);
                            ...
                            ?>       
                                <tr>
                                    ...
                                    <td>
                                        <a href="../Interface/ChiTietCongViec.php?ngay=<?php echo $row['Ngay'];?>">Xem chi tiết
                                        </a>
                                    </td>
                                </tr>
                            <?php
